    ...
    return (
        <div className="sm:py-8 sm:px-5 py-4 px-3">
            ...
            <div className="flex justify-between items-center">
                ...
                <Link href={'/admin/dashboard/listings/newListing'} className="border border-black hover:text-white p-3 rounded-xl hover:bg-black transition duration-500 flex items-center justify-center gap-1.5">
